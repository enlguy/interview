    ...
    <MaxWidthWrapper>
      <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-10 text-lg">
          <DropdownMenu>
            <DropdownMenuTrigger>Sales Jobs</DropdownMenuTrigger>
            <DropdownMenuContent>
              <DropdownMenuLabel>Sales</DropdownMenuLabel>
              <DropdownMenuSeparator />
              <DropdownMenuItem>
                <Link href="/bdr">Business Development Representative</Link>
              </DropdownMenuItem>
              <DropdownMenuItem>
                <Link href="/lgacct">Large Account Management</Link>
              </DropdownMenuItem>
              <DropdownMenuSeparator />
              <DropdownMenuItem>
